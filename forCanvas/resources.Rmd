...
Directions for installing R and RStudio are provided [here](../Tutorials/Installing.pdf). The general
directions remain the same, but the current versions of R and RStudio have been updated to 4.0.2 and 1.3.1073, respectively.
