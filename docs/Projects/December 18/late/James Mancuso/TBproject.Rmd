...
```{r regression model}
glm_TB <- glm(TBdata$Completed ~ TBdata$Sex + TBdata$Age + TBdata$Race, family = binomial())
summary(glm_TB)
...
## counts <- table(TBdata%Recommended, TBdata$Completed)
## barplot(counts, main="Cascade of Care",
##  xlab="Step in the Cascade", col=c("darkblue","red"),
