---
title: "Practical R: Introductions"
...
topics <- c(
  ...
  'Data Structures in R .fatinline[(classes 5:30-7, 7-8:30)]',
  'R packages, data import/export',
  'Towards analytic data: Data Munging',
  ...
  'Statistical learning: Cluster analysis and pattern recognition .fatinline[(classes 5:30-7, 7-8:30)]',
  "More data munging with `purrr`: grouping, mapping and functional programming",
  "Basic bioinformatics: Bioconductor and friends",
  ".heatinline[No class (Thanksgiving)]",
  "More complex visualizations and RMarkdown",
...
- Primarily via `r fa('slack')` [Slack](http://www.slack.com). 
  ...
  - You will see two channels named `r fa('slack-hash')`*wed5-7_2019* and `r fa('slack-hash')`*wed7-9_2019*. Please join the channel corresponding to your section. 
...
.center[
```{r, echo = F, out.height='350px', out.width='350px'}
...
.right-column30[
```{r, echo = F, out.width = "600px", out.height="400px"}
