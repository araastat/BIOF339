---
title: "Loops, Maps, and Table One"
...
.pull-right[
```{r, eval=T, echo = F, ref.label="plt1"}
```
]
```{r}
...
tab2 <- CreateTableOne(vars = myVars, data = pbc, factorVars = catVars, strata='trt')
