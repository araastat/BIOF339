...
.pull-right[
```{r, eval=T, echo = F, ref.label="tab1"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="tab2"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="tab2a"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="tab3"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="tab4"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="grp1", warning=F, message=F}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="grp1a", warning=F, message=F}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="grp1b"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="grp1c"}
```
]
...
CreateTableOne(
  ...
  test = F)
```
```{r, eval=T, echo = F, ref.label="grp1d"}
```
...
.pull-right[
```{r, eval=T, echo = F, ref.label="test1"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="test2"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="test2a"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="test2b"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="test2c"}
```
]
...
.pull-right[
```{r, eval=T, echo = F, ref.label="test3"}
```
]
...
```
```{r, eval=T, echo = F, ref.label="table4"}
```
...
```
```{r, eval=T, echo = F, ref.label="table4a"}
```
