...
Data: [link](lectures/data/Dataset_spine.csv)

## Lecture 7

The annotated R file is [here](notes/Supplement_06.R). There are also nicely 
formated documents ([HTML](notes/Supplement_06.html)|[PDF](notes/Supplement_06.pdf))
